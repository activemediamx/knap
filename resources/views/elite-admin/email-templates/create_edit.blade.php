...
<div class="modal-body">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="textarea" class="form-control" name="body" placeholder="@lang('core.enterText')" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $editTemplate->body ?? '' !!}</textarea>
            </div>
        </div>
...
<div class="modal-footer">
    <button id="save" type="submit" class="btn btn-custom" onclick="knap.addUpdate('email-templates', '{{$editTemplate->id ?? ''}}');return false">@lang('core.submit')</button>
